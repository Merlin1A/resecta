...
- **Engine package** (`Packages/RedactionEngine/Tests`) — 1,852 Swift Testing `@Test` functions across 245 suites: the pipeline and rasterization, the verification layers, the security suites (fake redaction, pixel destruction, rotated-page coordinates, adversarial verification), search, detection, and the corpus measurement harnesses.
