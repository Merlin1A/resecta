...
struct DocumentStateVerifyingCancelTests {
    ...
    @Test("Cancel from verifying always yields .skipped after the legacy ocrReturnReport precedence path was removed")
    func testCancelFromVerifyingAlwaysYieldsSkipped() {
        // The legacy `ocrReturnReport` precedence path
